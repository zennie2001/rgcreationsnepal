...
export default function VisaCard({ className, smallTitle, title, description, step, image }: { className?: string; smallTitle: string; title: string; description: string; step: string; image: StaticImageData }) {
    return (
