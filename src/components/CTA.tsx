...
About Us
            ...
            <h1 className="lg:text-[40px] text-[30px] lg:leading-[46px] leading-[40px] py-3 font-semibold lg:text-start  text-secondary text-center">
            Prepare to Set Out on Your Adventure
            </h1>
            <p className='text-text lg:text-start text-center'>Learn more, keep yourself updated, and begin your path to academic success.</p>
