    ...
    <div className="w-full rounded-sm border border-borderColor  p-4">
      ...
      <div className="pt-5 flex flex-wrap lg:gap-32 gap-5 items-center">
        <div className="flex gap-3 items-center">
          <div className="size-[80px] rounded-sm bg-[#D9D9D9] lg:block hidden"></div>
          <div className="flex flex-col items-start gap-2">
            <p className="font-bold text-base text-darkGreen">Test Format</p>
        ...
        <div className="flex flex-col items-start gap-2">
          <p className="font-bold text-base text-darkGreen">Test Mode</p>
          <p className="text-sm text-text">Paper-Based/ Computer Delivered</p>
        </div>
        <div className="flex flex-col items-start gap-2">
          <p className="font-bold text-base text-darkGreen">Class Duration</p>
