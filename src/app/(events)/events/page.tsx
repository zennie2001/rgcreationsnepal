...
<p className="text-xl text-secondary font-semibold">Categories</p>
...
<input type="radio" />
<p className="text-sm text-text">All Programs</p>
</div>
<div className="flex gap-2 items-center">
<input type="radio" />
<p className="text-sm text-text">Global Events</p>
</div>
<div className="flex gap-2 items-center">
<input type="radio" />
<p className="text-sm text-text">Global Webinars</p>
</div>
...
<div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5 py-5">
