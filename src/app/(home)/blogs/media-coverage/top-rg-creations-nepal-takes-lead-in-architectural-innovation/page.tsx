...
export const metadata = {
  ...
  description:
    "Discover how RG Creations Nepal Pvt. Ltd. leads the way in innovative architectural design and premium construction services across Nepal, specializing in luxury resorts, banquet halls, nightclubs, and exclusive residential projects.",
};
                  ...
                  <div className="border-t border-gray-200 pt-6 mt-8">
                    <div className="lg:flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <a
                            href="https://enewspolar.com/rg-creations-nepal-takes-the-lead-in-architectural-innovation-and-hospitality-design/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className=" text-blue-600 hover:text-blue-400  "
                            >
                          https://enewspolar.com/rg-creations-nepal-takes-the-lead-in-architectural-innovation-and-hospitality-design/
                            </a>
