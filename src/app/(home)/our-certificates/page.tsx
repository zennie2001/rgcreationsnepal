...
export default function OurCertificate() {
  ...
  return (
    <main>
      <PageHeader link="/our-certificates" title="Our Certificates" />
          ...
          {images.map((e, i) => {
            return (
              <div key={i} className="flex flex-col items-center w-full ">
                ...
                <p className="text-base font-bold text-darkGreen py-2">
                  {e.name}
                </p>
              </div>
            );
