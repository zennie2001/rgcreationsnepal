    ...
    <main className="bg-white">
      ...
      <div className="container mx-auto px-4 py-2">
        <div className="flex items-center font-medium text-sm mb-4">
          ...
          <span className="text-darkGreen">Details</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-12">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-700 font-semibold border-b border-lightGreen pb-4 mb-6">{product.name}</p>
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <button className="flex-1 bg-darkGreen  text-white py-2 px-4 rounded">
                Add To Cart
              </button>
            </div>
          </div>
