...
import placeholderImage from "@/assets/images/visa3.png";
...
const benifits = [
  {
    ...
    description:
      "Counselors consider your academic background, career goals, financial situation, and personal preferences to recommend the best programs, universities, and countries.",
  },
  {
    pointNo: "02",
    title: "Expert Knowledge",
    description:
      "Get accurate details on admission requirements, deadlines, and visa regulations. Counselors are well-versed in international education systems, helping you navigate unfamiliar processes efficiently.",
  },
  {
    pointNo: "03",
    title: "Streamlined Application Process",
    description:
      "Expert guidance ensures all forms, essays, and documents are correctly prepared and submitted on time. Helps you build confidence for university interviews or visa appointments through mock sessions and feedback.",
  },
  {
    pointNo: "04",
    title: "Support with Financial Planning",
    description:
      "Personalized advice on scholarships and funding options that you qualify for. Help with creating a financial plan, including tuition, living costs, and travel expenses.",
  },
  {
    pointNo: "05",
    title: "Stress-Free Visa Process",
    description:
      "Clear instructions on visa documentation, application submission, and interviews. Ensures you meet all legal and regulatory requirements for the chosen destination.",
  },
  {
    pointNo: "06",
    title: "Enhanced Confidence and Decision-Making",
    description:
      "Simplifies complex decisions and reduces the anxiety associated with studying abroad. With a clear understanding of your options, you can make informed choices about your future.",
  },
];
...
const features = [
  {
    ...
    description:
      "Tailored guidance provided to each student based on their unique needs, aspirations, and circumstances. Direct interaction with the counselor allows for a detailed discussion of academic, career, and personal preferences.",
  },
  {
    title: "Online and Offline Appointment Options",
    description:
      "Convenient for students who cannot visit the counseling center physically. Students can access on-site resources, such as brochures, program catalogs, and direct interactions with multiple counselors.",
  },
  {
    title: "Experienced Counselors",
    description:
      "Counselors bring years of expertise in study-abroad guidance, ensuring students receive accurate, updated, and relevant advice.Their familiarity with international education systems, admission processes, and visa regulations helps streamline the process.",
  },
];
        ...
        <div className="flex_center lg:flex-row flex-col gap-8 w-full">
          <div className="lg:w-[45%] w-full flex flex-col gap-4">
            ...
            <p className="text-text lg:text-start text-center">
              ...
              job market, and the personal growth needed to succeed in an
              interconnected world.
            </p>
            <p className="text-text lg:text-start text-center">
              Studying abroad is a transformative experience that offers
              numerous academic, personal, and professional benefits. Gain a
              degree from top-ranked universities and institutions with global
              credibility. Exposure to cutting-edge research, modern
              curriculums, and advanced teaching methodologies.{" "}
            </p>
          </div>
            ...
            {steps.map((step, index) => {
              return (
                <button
                  ...
                  className={twMerge(
                    "text-sm font-medium py-3 px-6 rounded-md hover:text-tertiary w-max transition duration-300",
                    counSteps === step.link
          ...
          <div className="w-full gap-10 flex">
            <div className="w-[50%] gap-4 flex flex-col">
              ...
              <p className="text-text text-base">
                The initial consultation is the foundation of the study-abroad
                counseling process. During this session, counselors work closely
                with students to understand their individual needs, aspirations,
                and circumstances. This involves:
              </p>
              <ul className="text-base text-text list-disc">
                ...
                <li className="mb-2">
                  Understanding the student&apos;s long-term professional
                  aspirations and how studying abroad can help achieve them.
                </li>
                <li className="mb-2">
                  Discussing preferred fields of study, extracurricular
                  interests, and specific subject areas
                </li>
                <li className="mb-2">
                  Factoring in the student&apos;s preferred study destination,
                  cultural inclinations, lifestyle expectations, and any
                  location-specific priorities.
                </li>
                <li className="mb-2">
                  Evaluating the student&apos;s financial situation to recommend
        ...
        <div className="grid grid-cols-3 w-full gap-8">
          {features.map((feature, index) => {
            return (
              <div
                key={index}
                className="flex_center flex-col gap-6 pt-14 p-8 bg-primary rounded-md col-span-1 relative"
              >
