            ...
            <section className="w-full flex_center flex-col lg:px-24 px-4 lg:py-16 py-10 gap-12">
                <div className="flex_center lg:flex-row flex-col gap-8 w-full">
                    <div className="lg:w-[45%] w-full flex flex-col gap-4">
                        ...
                        <p className="text-text lg:text-start text-center">
                        Studying abroad is a transformative experience that offers numerous academic, personal, and professional benefits. Gain a degree from top-ranked universities and institutions with global credibility. Exposure to cutting-edge research, modern curriculums, and advanced teaching methodologies.                        </p>
                    </div>
