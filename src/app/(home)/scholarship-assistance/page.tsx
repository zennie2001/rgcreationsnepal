      ...
      <section className="xl:px-24 lg:px-10 px-4 lg:py-16 py-10 ">
        ...
        <div className="mt-10">
          ...
          <p className="text-text py-2">
            San Francisco scholarship is one of the most sought after
            scholarship programmes offered to students looking to pursue
            postgraduate courses from the University of Oxford. Rhodes
            scholarship covers all University and College fees, a personal
            stipend and one economy class airfare to Oxford at the start of the
            Scholarship, as well as an economy flight back to the students home
            country at the conclusion of the Scholarship. This is one of the
            oldest scholarship programmes that started in 1902 with the will of
            Cecil John Rhodes. However, it was in 1947, the first Rhodes
            scholarship was awarded in India. It is not only the most
            prestigious but arduous scholarship to get. 
          </p>
        </div>
        <div className="mt-10">
          ...
          <ul className="text-text list-disc px-5">
            <li>
              ...
              college or university in San Francisco.
            </li>
            <li>
              Applicants must be preparing for a career in transportation or a
              transportation-related field.
            </li>
            <li>
              Relevant fields of study include transportation engineering,
