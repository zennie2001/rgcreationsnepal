...
const admissionProcesses = [
    {
        ...
        description: 'Our experienced counselors provide bespoke support, understanding each student’s academic background and aspirations.',
        step: '01'
    },
    {
        image: placeholderImage,
        ...
        description: 'We help students discover the ideal study destination, institution, and program tailored to their ambitions.',
        step: '02',
    ...
    },
    {
        ...
        description: 'Prepare for key exams like TOEFL, PTE, IELTS, GMAT, GRE, SAT, and ACT with personalized coaching from expert faculty.',
        step: '03'
    },
    {
        image: placeholderImage,
        ...
        description: 'Our experts focus on highlighting your strengths, meeting university-specific requirements, and eliminating errors to boost success rates and speed up responses.',
        step: '04',
        className: 'flex-row-reverse'
    },
    {
        ...
        description: 'We collaborate with students to refine documents, provide personalized recommendations to universities, and ensure all materials showcase the student’s potential for a perfect match.',
        step: '05',
    },
    {
        image: placeholderImage,
        ...
        description: 'Our specialists prepare students for university and visa interviews through mock sessions tailored to typical questions.',
        step: '06',
        className: 'flex-row-reverse'
    },
    {
        ...
        description: 'From document preparation to mock interviews, we provide end-to-end support based on updated consulate advice. Our proven strategies ensure a smooth experience, minimizing errors and delays.',
        step: '07',
    },
]
