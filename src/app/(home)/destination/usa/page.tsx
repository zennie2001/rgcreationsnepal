...
export default function USA() {
  return (
    <main className="w-full overflow-hidden">
      <PageHeader link="/destination/usa" title="USA" />
        ...
        <div className="flex_center flex-col gap-4 w-full">
          ...
          <div className="flex_center lg:flex-row flex-col  gap-8 w-full text-text">
            <p className="flex lg:w-1/2 w-full">
              With over 1.1 million international students, the USA has emerged
              as the number one study destination over the years. One of the
              major reasons for students flocking to study in USA is the
              excellent reputation that US universities and degrees hold.
            </p>
            <p className="flex lg:w-1/2 w-full">
              Diversity is another distinguishing factor that attracts students
              to pursue higher studies in USA. The country also provides ample
              work opportunities to the students during and after completion of
        ...
        <div className="flex flex-col w-full gap-8">
          <div className="flex w-full flex-col gap-4">
            ...
            <p className="text-text">
              ...
              pay out-of-state tuition, which is much more expensive.In
              contrast, private colleges charge higher fees, with the same
              amount of money collected from both domestic and foreign students.
              Community colleges are cost-effective educational alternatives,
              particularly in the first two years, before transferring to a
            ...
            <ul className="flex flex-col gap-5 text-text">
              ...
              <li>
                <span className="font-bold">Private Universities:</span>
                Tuition varies from $30,000 per year up to more than $60,000.
              </li>
              <li>
                <span className="font-bold">Community Colleges:</span>
                The tuition fees for international students range from $6,000 to
                $20,000 per year.
              </li>
            </ul>
          </div>
          <div className="flex w-full flex-col gap-4">
            ...
            <ul className="flex flex-col gap-5 text-text">
              <li>
                <span className="font-bold">On-Campus:</span>
                Costs range from $8,000 to $12,000 annually.
              </li>
              <li>
                <span className="font-bold">Off-Campus:</span>
                Rents range between $500 and $1,500 per month, depending on
                location and living circumstances.
              </li>
              <li>
                <span className="font-bold">Community Colleges:</span>
                The tuition fees for international students range from $6,000 to
          ...
          <div className="flex w-full flex-col gap-4">
            ...
            <ul className="flex flex-col gap-5 text-text">
              ...
              <li>
                ...
                Transportation costs differ by location, with $50-$100 per month
                expected for monthly public transportation tickets.
              </li>
              <li>
                <span className="font-bold">Utilities:</span>
                Those who live in off-campus apartments might have to pay
                $100-$200 for their utilities monthly.
              </li>
            </ul>
          </div>
        </div>
