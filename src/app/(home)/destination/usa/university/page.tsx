      ...
      <section className="w-full lg:px-24 px-4 lg:py-16 py-10 flex lg:gap-8 gap-4 lg:flex-row flex-col">
        ...
        <div className="flex flex-col gap-16 lg:w-[80%] w-full h-max">
          <div className="flex flex-col gap-8 w-full">
            <h3 className="text-3xl font-semibold text-darkGreen">
              Washington DC University
            </h3>
            <div className="grid lg:grid-cols-3 grid-cols-1 gap-8 w-full">
              {universities
                .filter((university) => university.location === "washington")
                .map((uni, index) => {
                  return (
                    <div
                      key={index}
                    ...
                    >
                      ...
                      <p className="text-darkGreen font-medium">
                        {uni.uniName}
                      </p>
                    </div>
                  );
          ...
          <div className="flex flex-col gap-8 w-full">
            ...
            <div className="grid lg:grid-cols-3 grid-cols-1 gap-8 w-full">
              {universities
                .filter((university) => university.location === "newyork")
                .map((uni, index) => {
                  return (
                    <div
                      key={index}
          ...
          <div className="flex flex-col gap-8 w-full">
            ...
            <div className="grid lg:grid-cols-3 grid-cols-1 gap-8 w-full">
              {universities
                .filter((university) => university.location === "francisco")
                .map((uni, index) => {
                  return (
                    <div
                      key={index}
