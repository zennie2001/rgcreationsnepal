...
export default function AboutChairmanHero() {
  return (
    <section className="relative h-screen w-full text-white">
      {/* Background Image */}
      <Image
        src="/about/chairman-banner.jpg" // Replace with your actual image path
        alt="Smart construction by Chairman"
        fill
      ...
      <div className="relative z-20 flex flex-col justify-center  items-center text-center h-full px-6">
        ...
        <h2 className="text-3xl md:text-5xl font-bold mb-4 tracking-wider  max-w-3xl">
          Visionary Leadership. Transforming Spaces, <br className="hidden md:block" /> 
           Inspiring Futures.
        </h2>
