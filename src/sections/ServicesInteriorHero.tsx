...
export default function ServicesInteriorHero() {
  return (
    <section className="relative h-screen w-full text-white">
      {/* Background Image */}
      <Image
        src="/about/20(1).jpg" // Replace with your actual image path
      ...
      <div className="relative z-20 flex flex-col justify-center  items-center text-center h-full px-6">
        <div className=" text-center border-b-2 w-[500px] mb-8">
          <p className="uppercase tracking-wider text-base font-medium mb-4" >
            Architectural & Interior <br className="lg:hidden sm:block"/> Design
          </p>
        </div>

        <h1 className="text-2xl md:text-4xl font-bold mb-4 tracking-wider  max-w-3xl">
           {/* <br className="hidden md:block" />  */}
           Designing Elegant, Functional, and Sustainable Spaces in Nepal – Custom Architecture and Interior Design Solutions That Bring Your Vision to Life
