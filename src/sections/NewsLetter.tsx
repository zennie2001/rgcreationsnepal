  ...
  const features = [
    {
      icon: (
        ...
        >
          <path
            d="M4.5 16.5L12 5.25L19.5 16.5H4.5Z"
            fill="#FF5722"
            stroke="#FF5722"
            strokeWidth="1.5"
            strokeLinecap="round"
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/2">
            <p className="text-darkGreen  text-center md:text-left font-medium mb-2">
              NEWSLETTER
            </p>
            ...
            <p className="text-gray-400  text-center md:text-left mb-8">
              Join our newsletter to receive sharp updates, members-only offers,
              and the latest from the world of Swift-Action. Stay connected —
              stay equipped.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-16">
              ...
              <button
                ...
                className="bg-darkGreen hover:bg-darkGreen text-white px-8 py-2 rounded-md font-medium transition-colors flex items-center justify-center"
              >
                SUBSCRIBE
                <svg
