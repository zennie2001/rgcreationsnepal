    ...
    <main className=" bg-black">
      <section className="flex flex-col lg:flex-row w-full container text-white px-5 py-16 lg:px-0 lg:py-32 items-center gap-12">
        ...
        <div className="w-full lg:w-1/2  flex flex-col gap-6">
          <p className="text-[#FF5A1F] md:text-left text-center font-medium text-sm">About us</p>
          <h2 className="text-xl sm:text-3xl md:text-4xl md:text-left text-center font-medium ">
            Crafted with Vision, Honed with <br className="hidden sm:block" />
            Purpose, Carried with Confidence
          </h2>
          <p className="text-gray-300 text-sm md:text-base md:text-left text-center leading-relaxed">
          ...
          <div className="flex flex-col md:text-left text-center sm:flex-row gap-8 pt-4">
