      ...
      <div className="container mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-600 text-sm leading-relaxed max-w-2xl">
            AT RG CREATIONS PVT. LTD., WE EXCEL AT CRAFTING EXCEPTIONAL SPACES DEFINED BY 
            LUXURY, INNOVATION, AND IMPECCABLE DESIGN. WE SPECIALIZE IN BUILDING TOP-CLASS 
            NIGHTCLUBS, LUXURIOUS RESIDENTIAL DEVELOPMENTS, AND COMMERCIAL PROJECTS THAT SET 
            NEW STANDARDS ACROSS NEPAL'S HOSPITALITY AND REAL ESTATE SECTORS.
          </p>
        </div>
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <img 
                src="https://images.unsplash.com/photo-1571176119204-7c4d2b35b8eb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                alt="Premium Nightclub Interior" 
                className="w-full h-96 object-cover rounded-sm shadow-lg"
              />
              <div className="absolute top-4 left-4 bg-pink-500 text-white rounded-full w-10 h-10 flex items-center justify-center">
                <span className="text-lg font-bold">$</span>
              </div>
            </div>
            <div className="lg:pl-8">
              <h3 className="text-3xl md:text-4xl font-bold text-black mb-6">
                PREMIUM NIGHTCLUB<br />
                CONSTRUCTION
              </h3>
              <p className="text-gray-600 text-sm leading-relaxed mb-8">
                DESIGNING AND BUILDING WORLD-CLASS NIGHTCLUBS FEATURING FLAWLESS 
                ARCHITECTURE, CUTTING-EDGE ACOUSTICS, AND IMMERSIVE LIGHTING TO CREATE 
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:pl-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-8">
                DEVELOPING OFFICE BUILDINGS, RETAIL SPACES, HOTELS, AND OTHER COMMERCIAL 
                PROJECTS TAILORED TO MEET YOUR BUSINESS GOALS AND ENHANCE OPERATIONAL 
                SUCCESS.
              </p>
              <button className="text-gray-500 text-sm font-medium tracking-widest hover:text-black transition-colors">
                READ MORE
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 lg:pr-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-8">
                PROVIDING INNOVATIVE DESIGNS FOR HOSPITALITY VENUES, LUXURY BOUTIQUE 
                HOTELS, EXCLUSIVE RESIDENCES, AND COMMERCIAL PROPERTIES - EACH 
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:pl-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-8">
                PROVIDING EXCLUSIVE, HIGH-QUALITY FURNITURE COLLECTIONS THAT BLEND STYLE, 
                COMFORT, AND DURABILITY, PERFECT FOR UPSCALE ENVIRONMENTS.
              </p>
              <button className="text-gray-500 text-sm font-medium tracking-widest hover:text-black transition-colors">
                READ MORE
              </button>
        ...
        <div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:pl-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-8">
                ENSURING SEAMLESS PROJECT DELIVERY FROM CONCEPT TO COMPLETION - ON 
